...
<body>
  ...
  { "en": "Apa Itu Loss Of Prime Mover?", "id": "Hilangnya Tenaga Penggerak Utama Turbin." },
  { "en": "Apa Itu Inadvertent Energization Logic?", "id": "Trafo Menyuplai Generator Saat Berhenti." },
  { "en": "Apa Itu Sequential Tripping Generator?", "id": "Stop Turbin Dulu Baru Breaker." },
  { "en": "Apa Itu Transformer Oil Oxidation?", "id": "Reaksi Minyak Dengan Oksigen Menua." },
  { "en": "Apa Itu Oil Sludge Formation?", "id": "Endapan Lumpur Hasil Oksidasi Minyak." },
  { "en": "Apa Itu Oil Interfacial Tension?", "id": "Tegangan Permukaan Minyak Terhadap Air." },
  { "en": "Apa Itu Oil Neutralization Number?", "id": "Ukuran Tingkat Keasaman Minyak Isolasi." },
  { "en": "Apa Itu Furanic Compound Analysis?", "id": "Indikator Degradasi Kertas Isolasi Selulosa." },
  { "en": "Apa Itu Degree Of Polymerization Test?", "id": "Uji Kekuatan Mekanis Kertas Isolasi." },
  { "en": "Apa Itu Corrosive Sulfur In Oil?", "id": "Sulfur Reaktif Penyebab Kegagalan Isolasi." },
  { "en": "Apa Itu Copper Sulphide Deposit?", "id": "Endapan Konduktif Pada Kertas Isolasi." },
  { "en": "Apa Itu Passivator Additive Oil?", "id": "Zat Kimia Pencegah Korosi Sulfur." },
  { "en": "Apa Itu Oil Reclamation Process?", "id": "Proses Pemurnian Kembali Minyak Bekas." },
  { "en": "Apa Itu Vacuum Oil Filling?", "id": "Pengisian Minyak Dalam Kondisi Hampa." },
  { "en": "Apa Itu Transformer Dry Out Process?", "id": "Proses Pemanasan Membuang Uap Air." },
  { "en": "Apa Itu Hot Oil Spray Process?", "id": "Menyemprot Minyak Panas Bersihkan Inti." },
  { "en": "Apa Itu Vapor Phase Drying?", "id": "Pengeringan Menggunakan Uap Solvent Kerosin." },
  { "en": "Apa Itu Excitation Current Measurement?", "id": "Deteksi Masalah Inti Dan Lilitan." },
  { "en": "Apa Itu Magnetic Balance Test?", "id": "Uji Keseimbangan Fluks Tiga Fasa." },
  { "en": "Apa Itu Bushing Power Factor Test?", "id": "Uji Kualitas Isolasi Bushing Trafo." },
  { "en": "Apa Itu Bushing C1 Capacitance?", "id": "Kapasitansi Utama Konduktor Ke Tap." },
  { "en": "Apa Itu Bushing C2 Capacitance?", "id": "Kapasitansi Tap Ke Flange Ground." },
  { "en": "Apa Itu Hot Collar Test Bushing?", "id": "Uji Isolasi Bagian Atas Bushing." },
  { "en": "Apa Itu Leakage Reactance Transformer?", "id": "Reaktansi Akibat Fluks Yang Bocor." },
  { "en": "Apa Itu Zero Sequence Impedance Trafo?", "id": "Impedansi Trafo Saat Gangguan Tanah." },
  { "en": "Apa Itu Transformer Sound Level Test?", "id": "Pengukuran Tingkat Kebisingan Suara Trafo." },
  { "en": "Apa Itu Transformer Heat Run Test?", "id": "Uji Kenaikan Suhu Beban Penuh." },
  { "en": "Apa Itu Short Circuit Withstand Test?", "id": "Uji Ketahanan Mekanis Arus Gangguan." },
  { "en": "Apa Itu Impulse Voltage Withstand Test?", "id": "Uji Ketahanan Isolasi Surja Petir." },
  { "en": "Apa Itu Switching Impulse Withstand Test?", "id": "Uji Ketahanan Isolasi Surja Hubung." },
  { "en": "Apa Itu Induced Overvoltage Test?", "id": "Uji Isolasi Antar Lilitan Trafo." },
  { "en": "Apa Itu Applied Voltage Test?", "id": "Uji Isolasi Lilitan Ke Tanah." },
  { "en": "Apa Itu Partial Discharge Measurement?", "id": "Deteksi Cacat Isolasi Tanpa Merusak." },
  { "en": "Apa Itu RIV Test Transformer?", "id": "Uji Gangguan Radio Akibat Korona." },
  { "en": "Apa Itu Cable Sheath Voltage Limiter?", "id": "Arrester Pelindung Isolasi Jaket Kabel." },
  { "en": "Apa Itu Contact Resistance Link Box?", "id": "Tahanan Kontak Baut Sambungan Link." },
  { "en": "Apa Itu Cable Discharge Method?", "id": "Cara Buang Muatan Setelah Uji." },
  { "en": "Apa Itu VLF Tan Delta Test?", "id": "Diagnostik Penuaan Kabel Frekuensi Rendah." },
  { "en": "Apa Itu VLF Partial Discharge Test?", "id": "Lokalisasi Cacat Kabel Frekuensi Rendah." },
  { "en": "Apa Itu Damped AC Voltage Test?", "id": "Uji Kabel Dengan Osilasi Teredam." },
  { "en": "Apa Itu Time Domain Reflectometry?", "id": "Radar Kabel Cari Jarak Gangguan." },
  { "en": "Apa Itu High Resistance Fault Locator?", "id": "Alat Cari Gangguan Tahanan Tinggi." },
  { "en": "Apa Itu Cable Thumper Surge Generator?", "id": "Pembangkit Hentakan Tegangan Cari Gangguan." },
  { "en": "Apa Itu Acoustic Fault Pinpointing?", "id": "Mendengar Suara Ledakan Dalam Tanah." },
  { "en": "Apa Itu Electromagnetic Impulse Detection?", "id": "Deteksi Medan Magnet Saat Thumping." },
  { "en": "Apa Itu Cable Route Tracer?", "id": "Alat Pelacak Jalur Kabel Tanam." },
  { "en": "Apa Itu Cable Identification Instrument?", "id": "Alat Memastikan Kabel Sebelum Potong." },
  { "en": "Apa Itu Phase Verification Tool?", "id": "Alat Cek Urutan Fasa Kabel." },
  { "en": "Apa Itu Insulator Pollution Level?", "id": "Tingkat Kekotoran Lingkungan Isolator." },
  { "en": "Apa Itu ESDD Pollution Measurement?", "id": "Ukur Kepadatan Garam Pada Isolator." },
  { "en": "Apa Itu NSDD Pollution Measurement?", "id": "Ukur Kepadatan Debu Tak Larut." },
  { "en": "Apa Itu Leakage Distance Ratio?", "id": "Jarak Rambat Spesifik Per kV." },
  { "en": "Apa Itu Insulator Washing Equipment?", "id": "Alat Cuci Isolator Bertekanan Tinggi." },
  { "en": "Apa Itu Live Line Washing?", "id": "Mencuci Isolator Saat Bertegangan." },
  { "en": "Apa Itu Silicon Grease Coating?", "id": "Pelapis Isolator Menolak Air Hujan." },
  { "en": "Apa Itu RTV Silicon Coating?", "id": "Karet Silikon Cair Pelapis Isolator." },
  { "en": "Apa Itu Insulator Hydrophobicity Class?", "id": "Kelas Kemampuan Menolak Air Permukaan." },
  { "en": "Apa Itu Corona Camera Inspection?", "id": "Visualisasi Korona Dengan Kamera UV." },
  { "en": "Apa Itu Ultrasound Corona Detection?", "id": "Deteksi Suara Korona Frekuensi Tinggi." },
  { "en": "Apa Itu Grading Ring Installation?", "id": "Pasang Cincin Perata Medan Listrik." },
  { "en": "Apa Itu Arcing Horn Gap Setting?", "id": "Jarak Sela Tanduk Api Pelindung." },
  { "en": "Apa Itu Stockbridge Damper Frequency?", "id": "Frekuensi Resonansi Peredam Getar." },
  { "en": "Apa Itu Spacer Damper Installation?", "id": "Pasang Pemisah Kabel Berkas Peredam." },
  { "en": "Apa Itu Aircraft Warning Sphere?", "id": "Bola Penanda Kabel Untuk Pesawat." },
  { "en": "Apa Itu Tower Footing Resistance?", "id": "Tahanan Pentanahan Kaki Tiang Tower." },
  { "en": "Apa Itu Counterpoise Wire Installation?", "id": "Tanam Kawat Tanah Paralel Transmisi." },
  { "en": "Apa Itu Soil Resistivity Measurement?", "id": "Ukur Tahanan Jenis Tanah Lokasi." },
  { "en": "Apa Itu Wenner Four Point Method?", "id": "Metode Standar Ukur Resistivitas Tanah." },
  { "en": "Apa Itu Fall Of Potential Method?", "id": "Metode Tiga Titik Ukur Grounding." },
  { "en": "Apa Itu Step Voltage Measurement?", "id": "Ukur Tegangan Antara Dua Kaki." },
  { "en": "Apa Itu Touch Voltage Measurement?", "id": "Ukur Tegangan Antara Tangan Kaki." },
  { "en": "Apa Itu Mesh Voltage Calculation?", "id": "Hitung Tegangan Sentuh Maksimum Grid." },
  { "en": "Apa Itu Ground Grid Conductor?", "id": "Kawat Tembaga Jaring Bawah Tanah." },
  { "en": "Apa Itu Exothermic Welding Connection?", "id": "Sambungan Las Kimia Kabel Ground." },
  { "en": "Apa Itu Compression Ground Connector?", "id": "Konektor Pres Mekanis Kabel Ground." },
  { "en": "Apa Itu Chemical Ground Rod?", "id": "Elektroda Pipa Isi Garam Mineral." },
  { "en": "Apa Itu Concrete Encased Electrode?", "id": "Elektroda Dalam Pondasi Beton Ufer." },
  { "en": "Apa Itu Grounding Busbar Panel?", "id": "Rel Tembaga Terminal Tanah Panel." },
  { "en": "Apa Itu Lightning Protection Zone?", "id": "Area Terlindung Dari Sambaran Petir." },
  { "en": "Apa Itu Rolling Sphere Method?", "id": "Metode Desain Radius Proteksi Petir." }
